...
def save_report_metric(metrics, i):
    ...
    prediction_drift, num_drifted_columns, share_missing_values = metrics

    logger.info('saving reports...')
    with psycopg.connect(POSTGRES_URI, autocommit=True) as conn:
        conn.execute(
            "INSERT into model_metrics(timestamp, prediction_drift, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s)",
